  ...
  const updateConversion = useCallback(
    (value: any) => {
      ...
      if (!isNaN(usd) && selectedAsset) {
        ...
        const sellRate = parseFloat(selectedAsset.buy_rate ?? "0");
      ...
      >
        <View style={styles.container}>
          <View>
            ...
            <Text style={styles.label}>Enter the amount you want to sell</Text>
            ...
            >
              <Text style={styles.rate}>
                Rate: {formatAmount(selectedAsset?.buy_rate ?? 0)}/$
              </Text>
