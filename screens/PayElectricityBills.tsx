    ...
    <SafeAreaView edges={["right", "left"]} style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity
          style={[styles.button, isDisabled && { opacity: 0.5 }]}
          onPress={handleSubmit(onSubmit)}
          // Fixed: this was commented out, meaning the button visually dimmed
          // but never actually blocked a tap — meterValid=false or an
          // insufficient balance couldn't stop submission before now.
          disabled={isDisabled}
        >
          <AppText style={styles.buttonText}>
            {isSubmitting
