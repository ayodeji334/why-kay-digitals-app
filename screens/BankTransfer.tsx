...
//                 activeOpacity={0.7}
//                 onPress={() =>
//                   copyToClipboard(data?.account_name, "accountName")
//                 }
//                 style={styles.copyableField}
//               >
//                 <View style={styles.rowIconButton}>
//                   {renderCopyIcon("accountName")}
//                 </View>
//                 <AppText style={styles.detailValue} numberOfLines={1}>
//                   {data?.account_name}
//                 </AppText>
...
//               <TouchableOpacity
//                 activeOpacity={0.7}
//                 onPress={() => copyToClipboard(BANK_NAME, "bankName")}
//                 style={styles.copyableField}
//               >
//                 <View style={styles.rowIconButton}>
//                   {renderCopyIcon("bankName")}
//                 </View>
...
//               "A transaction fee will be deducted from your wallet balance for each deposit",
...
const BankTransferScreen = () => {
  ...
  const renderCopyRow = (
    ...
    <View style={styles.detailItem}>
      ...
      <TouchableOpacity
        ...
        style={styles.copyableField}
      >
        <AppText style={[styles.detailValue, valueStyle]} numberOfLines={1}>
          {value}
        </AppText>
        <View style={styles.rowIconButton}>{renderCopyIcon(field)}</View>
      </TouchableOpacity>
    </View>
  );
  ...
  const hasNoVirtualAccount =
    user?.bvn_verification_status === "VERIFIED" &&
    data &&
    Object.keys(data).length <= 0;

  if (hasNoVirtualAccount) {
    return (
      <SafeAreaView
        edges={["right", "bottom", "left"]}
        style={styles.container}
    ...
    <SafeAreaView edges={["right", "left"]} style={styles.container}>
      {user?.bvn_verification_status !== "VERIFIED" ? (
        ...
        >
          ...
          <View style={styles.accountSection}>
            {renderCopyRow("Account Name", data?.account_name, "accountName")}
            {renderCopyRow("Bank Name", BANK_NAME, "bankName")}
            {renderCopyRow(
              "Account Number",
              data?.account_number,
              "accountNumber",
