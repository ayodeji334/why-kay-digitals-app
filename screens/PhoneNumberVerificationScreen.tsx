...
export default function PhoneNumberVerificationScreen() {
  ...
  const subtitle =
    step === "otp"
      ? "Enter the 6-digit code we just sent to your phone to confirm it's really you."
      : "Verify your phone number to secure your account and unlock deposits, withdrawals, and other services. We'll send a one-time code to confirm it's really you.";
  ...
  return (
    <SafeAreaView edges={["right", "left"]} style={styles.container}>
      ...
      >
        ...
        <View style={styles.formSection}>
          <PhoneNumberForm onStepChange={setStep} />
        </View>
      </ScrollView>
    </SafeAreaView>
  );
